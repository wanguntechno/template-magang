...
if (!function_exists('getDayAndNightFromDateRange')) {
    /**
     * Get icon
     *
     * @param $path
     ...
     * @return string
     */
    function getDayAndNightFromDateRange($start, $end)
    {
...
if (!function_exists('handleDivisionByZero')) {
    /**
     * Get icon
     *
     * @param $path
     ...
     * @return string
     */
    function handleDivisionByZero($a,$b)
    {
